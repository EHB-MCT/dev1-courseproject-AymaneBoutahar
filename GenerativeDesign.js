...
// 18/12/2024: https://chatgpt.com/share/6762c9c2-1620-8006-8698-2d5143176f66, https://chatgpt.com/share/6762d9a6-c038-8006-a810-40817bc7913f, https://chatgpt.com/share/67630ba5-1b70-8006-9b7e-624761d63321
...
function SpaceInvader() {
	...
	//De kleur van de space invader
	context.fillStyle = "#4ee44e";
	//de spaceInvader zelf
	context.fillRect(beginX, beginY, 50, 50);
	context.fillRect(beginX + 50, beginY, 50, 50);
	context.fillRect(beginX + 150, beginY, 50, 50);
	context.fillRect(beginX + 200, beginY, 50, 50);
	context.fillRect(beginX + 150, beginY - 50, 50, 50);
	context.fillRect(beginX + 50, beginY - 50, 50, 50);
	context.fillRect(beginX + 50, beginY - 100, 50, 50);
	context.fillRect(beginX, beginY - 100, 50, 50);
	context.fillRect(beginX + 200, beginY - 100, 50, 50);
	context.fillRect(beginX + 150, beginY - 100, 50, 50);
	context.fillRect(beginX, beginY + 100, 50, 50);
	context.fillRect(beginX + 50, beginY + 100, 50, 50);
	context.fillRect(beginX + 150, beginY + 100, 50, 50);
	context.fillRect(beginX + 200, beginY + 100, 50, 50);
